...
//            -----------------------  Magazine Luiza  --------------------
        ...
        scrapperTVMG.getAllProductMagalu(17 , "src/main/java/com/api/webscrapingmagalu/files/MagaluTV.txt");

        MagaluScrapper scrapperSmartphoneMG = new MagaluScrapper("https://www.magazineluiza.com.br/busca/smartphone/?page=");
        scrapperSmartphoneMG.getAllProductMagalu(17 , "src/main/java/com/api/webscrapingmagalu/files/MagaluSmartphone.txt");

        MagaluScrapper scrapperNotebookMG = new MagaluScrapper("https://www.magazineluiza.com.br/busca/notebook/?page=");
        scrapperNotebookMG.getAllProductMagalu(17 , "src/main/java/com/api/webscrapingmagalu/files/MagaluNotebook.txt");

        MagaluScrapper scrapperWatchMG = new MagaluScrapper("https://www.magazineluiza.com.br/busca/smart+watch/?page=");
        scrapperWatchMG.getAllProductMagalu(17 , "src/main/java/com/api/webscrapingmagalu/files/MagaluSmartwatch.txt");

        MagaluScrapper scrapperPlacaVideoMG = new MagaluScrapper("https://www.magazineluiza.com.br/busca/placa+de+video/?page=");
        scrapperPlacaVideoMG.getAllProductMagalu(17 , "src/main/java/com/api/webscrapingmagalu/files/MagaluPlacaDevideo.txt");
...
//              -----------------------  Lojas Americanas  --------------------
        ...
        scrapperSmartphoneAM.getAllProductAM(20 , "src/main/java/com/api/webscrapingmagalu/files/AmericanasSmartphone.txt");
        ...
        scrapperNotebookAM.getAllProductAM(20 , "src/main/java/com/api/webscrapingmagalu/files/AmericanasNotebook.txt");
        ...
        scrapperSmartwatchAM.getAllProductAM(10 , "src/main/java/com/api/webscrapingmagalu/files/AmericanasSmartwatch.txt");
        ...
        scrapperTVAM.getAllProductAM(10 , "src/main/java/com/api/webscrapingmagalu/files/AmericanasTV.txt" );
        ...
        scrapperPlacaDeVIdeoAM.getAllProductAM(20 , "src/main/java/com/api/webscrapingmagalu/files/AmericanasPlacaDeVideo.txt");
